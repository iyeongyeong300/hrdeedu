...
//-->
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
				  ...
				  <tr>
                    <th>사업자 번호</th>
                    <td><input name="CompanyCode" id="CompanyCode" type="text"  size="20" value="<?=$CompanyCode?>" maxlength="10">&nbsp;&nbsp;
                  ...
                  <tr>
                    <th>사업주 ID</th>
                    <td><input name="CompanyID" id="CompanyID" type="text"  size="20" value="<?=$CompanyID?>">&nbsp;&nbsp;
				  ...
				  <tr>
                    <th>영업담당자명</th>
                    <td><input name="SalesName" id="SalesName" type="text"  size="20" value="<?=$SalesName?>">&nbsp; 
