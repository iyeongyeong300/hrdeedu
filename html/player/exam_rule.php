 ...
 <div class="eduExam" id="AgreeForm" style="display:none">
	...
	<div class="ruleArea">
		...
		<ol>
			...
			<li>중간평가는 <span class="fcRed01B">훈련기간 종료일 다음날로부터 1주일 이내 재응시(N차 평가) 실시 가능</span>합니다.<br />
		             기존 원격훈련 중 국민내일배움카드에서만 N차 평가를 허용하였으나, 관련 규정 개정(‘21.1.1.)으로 사업주훈련에서도 동일기간 내에서 N차 평가 실시 가능</li>
			...
			<li>최종평가는 <span class="fcRed01B">훈련기간 종료일 다음날로부터 1주일 이내 재응시(N차 평가) 실시 가능</span>합니다.<br />
		             기존 원격훈련 중 국민내일배움카드에서만 N차 평가를 허용하였으나, 관련 규정 개정(‘21.1.1.)으로 사업주훈련에서도 동일기간 내에서 N차 평가 실시 가능</li>
			<li><span class="fcRed01B">반드시 PC에서 진행</span>하여 주시고, 장애가 발생하지 않도록 유선 인터넷 등을 사용하시기 바랍니다.</li>
			...
			<li>과제는 <span class="fcRed01B">훈련기간 종료일 다음날로부터 1주일 이내 재응시(N차 평가) 실시 가능</span>합니다.<br />
		             기존 원격훈련 중 국민내일배움카드에서만 N차 평가를 허용하였으나, 관련 규정 개정(‘21.1.1.)으로 사업주훈련에서도 동일기간 내에서 N차 평가 실시 가능</li>
			<li><span class="fcRed01B">반드시 PC에서 진행</span>하여 주시고, 장애가 발생하지 않도록 유선 인터넷 등을 사용하시기 바랍니다.</li>
			<li><span class="fcRed01B">최종제출 버튼까지 클릭</span> 후 제출해야지만 평가 응시가 완료됩니다.</li>
			<li>최종제출을 하지 않은 상태로 평가시간이 종료될 경우 <span class="fcRed01B">작성한 답안으로 자동 제출</span>됩니다.</li>
