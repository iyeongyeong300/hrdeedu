...
$Sql = "SELECT Mobile, Name, BirthDay FROM Member WHERE ID='$LoginMemberID'";
...
<?
	...
	$CertDate = date("Y-m-d");
	$CertType = "mobile";
	$Sql = "INSERT INTO UserCert(Seq, ID, LectureCode, CertDate, CertType, RegDate) VALUES($maxno, '$LoginMemberID', '$requestnumber', '$CertDate', '$CertType', NOW())";
	$Row = mysql_query($Sql);
