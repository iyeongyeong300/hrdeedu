...
$Mobile = str_replace("-","",$Mobile); //회원정보의 휴대폰 번호
...
<script type="text/javascript" src="./include/function.js?t=20190210"></script>
</head>

<body>
<?
if(($Mobile != $mobileno) || ($UserName != $name) || ($UserBirthDay != $birthdate)) {
?>
