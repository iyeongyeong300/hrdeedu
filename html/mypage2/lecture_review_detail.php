                            ...
                            <div class="myLectureList">
								...
								?>
									  ...
									  <ul>
										...
										<li><?if($MidTestStudy=="Y") {?><span class="btnViewTy03"><a href="Javascript:StudyCorrectResult('<?=$Study_Seq?>','MidTest');">결과/첨삭보기</a></span><?}?></li>
									</ul>
								<?
									}else{
								?>
								...
								?>
									...
									<ul  >
										...
										<li><span class="btnViewTy02"><?if($TestStudy=="N") {?><a href="Javascript:ExamStart('<?=$Study_Seq?>','<?=$LectureCode?>','<?=$ROW2['Chapter_Seq']?>','Test');">평가응시</a><?}?></span></li>
									</ul>
								<?
									}
								?>
								...
								?>
                                    ...
                                    <li><?if($ReportStudy=="Y") {?><span class="btnViewTy03"><a href="Javascript:StudyCorrectResult('<?=$Study_Seq?>','Report');">결과/첨삭보기</a></span><?}?></li>
                                </ul>
								<?
									}else{
								?>
