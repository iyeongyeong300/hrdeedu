...
<div class="certi_print">
    ...
    <div class="infoArea">
        ...
        <div class="txt_ty01" style="margin-top:20px;">위 사람은 국민 평생 직업능력 개발법 제20조 및<br />
			제24조의 규정에 의하여 본 교육원이 실시한<br />
			아래의 교육을 위 기간 동안에 성실히<br />
			수행하였기에 본 증서를 수여합니다.
        </div>
		...
		<?}else{?>
        <div class="txt_ty02"><br /><br /></div>
		<?}?>
        
        <div class="txt_ty01"><?=$resultDate?></div>
        
        <div class="txt_ty03">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$CertSiteName?>
		<img src="/images/company_stamp3.png" align="absmiddle" width="110" height="110" /></div>
