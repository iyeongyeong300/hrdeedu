...
$Sql = "SELECT a.*, a.Seq AS Study_Seq, a.MidSaveTime, a.TestSaveTime, a.ReportSaveTime, a.MidIP, a.TestIP, a.ReportIP, a.PassOk, a.StudyEnd, a.LectureReStudy, 
			...
			WHERE a.ID='$LoginMemberID' AND a.LectureEnd < '$NowDate' AND DATE_ADD( a.LectureEnd, INTERVAL 7 DAY)   >= '$NowDate' AND a.Seq=$Seq";
// 리스트와 쿼리가 달라서 쿼리 변경
                            ...
                            <div class="myLectureList">
                                ...
                                <ul>
                                    ...
                                    <li>
										...
										<?if(($StudyEnd=="N")&&($LectureReStudy2>=date('Y-m-d'))) {?>
											<?if($MidStatus=="C") {?><span class="btnViewTy02"><a href="Javascript:MidResetProcess(<?=$Seq?>);">재응시요청</a></span><?}?>
 										<?}?>
								...
								?>
									...
									<ul  >
										...
										<li><span class="btnViewTy02"><?if($MidTestStudy=="N") {?><a href="Javascript:ExamStart('<?=$Study_Seq?>','<?=$LectureCode?>','<?=$ROW2['Chapter_Seq']?>','MidTest');">평가응시</a><?}?></span></li>
									</ul>
								<?
									}
								?>
								...
								<ul>
									...
									<?if(($StudyEnd=="N")&&($LectureReStudy2>=date('Y-m-d'))) {?>
 											<?if($TestStatus=="C") {?><span class="btnViewTy02"><a href="Javascript:TestResetProcess(<?=$Seq?>);">재응시요청</a></span><?}?>
 										<?}?>									
									</li>
                                </ul>
								<?
								...
								<ul>
									...
									<?if(($StudyEnd=="N")&&($LectureReStudy2>=date('Y-m-d'))) {?>
 											<?if($ReportStatus=="C") {?><span class="btnViewTy02"><a href="Javascript:ReportResetProcess(<?=$Seq?>);">재응시요청</a></span><?}?>
										<?}?>
								...
								?>
									...
									<ul  >
										...
										<li><span class="btnViewTy02"><?if($ReportStudy=="N") {?><a href="Javascript:ExamStart('<?=$Study_Seq?>','<?=$LectureCode?>','<?=$ROW2['Chapter_Seq']?>','Report');">평가응시</a><?}?></span></li>
									</ul>
								<?
									}
								?>
