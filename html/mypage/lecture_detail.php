...
// echo $Sql;
$Respsult = mysqli_query($connect, $Sql);
$Row = mysqli_fetch_array($Respsult); // Brad(2021.11.14) : 변수명 수정
...
<!--
	...
	//location.href="/mypage/lecture.php";
	location.href="/new/mypage/lecture.html";
//-->
</script>
<?
}
                            ...
                            <div class="myList">
                                <ul class="area">
                                    ...
                                    <li class="lecInfo">
										...
										?>
                                        <div class="lecBtn">
                                            <?if($StatusBtnDisplay == "Y") {?><span class="btn02"><a href="Javascript:<?=$DirecFunction?>"><?=$DirectBtnLabel?></a></span><?}else{?><br><?}?>
                                      	</div>
                                        <!-- btn // -->
                                    </li>
                                    <!-- 상태 -->
                            ...
                            <div class="myLectureList">
                            	...
                            	<ul class="<?=$Active?>">
									...
									<?if($LectureStudy=="Y" || $ChapterProgress>=100) {?>	
										<span class="btnViewTy02"><a href="Javascript:Play( '<?=$k?>','<?=$LectureCode?>','<?=$Study_Seq?>','<?=$ROW2['Chapter_Seq']?>','<?=$ROW2['Contents_idx']?>','<?=$PlayMode?>');">수강하기</a></span>										
									<?}else{?>
									<span class="btnViewTy01">수강하기</span>
									<?}?>
									</li>
                                </ul>
								<?
								...
								?>
                                <ul <?if($MidTestStudy=="Y") {?>class="on"<?}else{?>class="off"<?}?>>
                                	<li>[평가]</li>
                                    <li class="infoArea">
                                    ...
                                    <li>
									<?if($MidTestStudy=="Y") {?>
									<span class="btnViewTy02"><a href="Javascript:ExamStart('<?=$Study_Seq?>','<?=$LectureCode?>','<?=$ROW2['Chapter_Seq']?>','MidTest');">평가응시</a></span>
									<?}else{?>
										<?if($MidScore && $MidScore<100 && $BClassLecture=="Y") {?>
										<span class="btnViewTy02"><a href="Javascript:MidExamStudy('<?=$Study_Seq?>','<?=$LectureCode?>','<?=$ROW2['Chapter_Seq']?>','0');">맞춤형<br>동영상<br>보충학습</a></span>
										<?}else{?>
										<span class="btnViewTy01">평가응시</span>
										<?}?>
									<?}?>
									</li>
                                </ul>
								...
								?>
                                <ul <?if($TestStudy=="Y") {?>class="on"<?}else{?>class="off"<?}?>>
                                	<li>[평가]</li>
                                    <li class="infoArea">
                                    ...
                                    <li>
									<?if($TestStudy=="Y") {?>
									<span class="btnViewTy02"><a href="Javascript:ExamStart('<?=$Study_Seq?>','<?=$LectureCode?>','<?=$ROW2['Chapter_Seq']?>','Test');">평가응시</a></span>
									<?}else{?>
									<span class="btnViewTy01">평가응시</span>
									<?}?>
									</li>
								...
								?>
                                <ul <?if($ReportStudy=="Y") {?>class="on"<?}else{?>class="off"<?}?>>
                                	<li>[평가]</li>
                                    <li class="infoArea">
                                    ...
                                    <li>
									<?if($ReportStudy=="Y") {?>
									<span class="btnViewTy02"><a href="Javascript:ExamStart('<?=$Study_Seq?>','<?=$LectureCode?>','<?=$ROW2['Chapter_Seq']?>','Report');">평가응시</a></span>
									<?}else{?>
									<span class="btnViewTy01">평가응시</span>
									<?}?>
									</li>
