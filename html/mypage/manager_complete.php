                    ...
                    <div class="conInfoArea">
                        ...
                        <div class="PageZone">
                            ...
                            <div class="myManagerList">
								...
								<?
								$i = 1;
								$SQL = "SELECT DISTINCT a.LectureStart AS LectureStart, a.LectureEnd FROM Study AS a LEFT OUTER JOIN Company AS b ON a.CompanyCode=b.CompanyCode WHERE a.CompanyCode='$CompanyCode' AND a.ServiceType IN (1,3,5,9) ORDER BY a.LectureStart ASC, a.LectureEnd ASC ";
								...
								(SELECT COUNT(*) FROM Study WHERE LectureCode=a.LectureCode AND LectureStart=a.LectureStart AND LectureEnd=a.LectureEnd AND CompanyCode=a.CompanyCode AND ServiceType=1 AND PassOk='Y') AS StudyCount, 
								(SELECT COUNT(*) FROM Study WHERE LectureCode=a.LectureCode AND LectureStart=a.LectureStart AND LectureEnd=a.LectureEnd AND CompanyCode=a.CompanyCode AND ServiceType=1 AND PassOk='N') AS StudyBeCount, 
								(SELECT COUNT(*) FROM Study WHERE LectureCode=a.LectureCode AND LectureStart=a.LectureStart AND LectureEnd=a.LectureEnd AND CompanyCode=a.CompanyCode AND ServiceType IN (3,5,9) AND PassOk='Y') AS StudyCount2, 
								(SELECT COUNT(*) FROM Study WHERE LectureCode=a.LectureCode AND LectureStart=a.LectureStart AND LectureEnd=a.LectureEnd AND CompanyCode=a.CompanyCode AND ServiceType IN (3,5,9) AND PassOk='N') AS StudyBeCount2, 
