...
<!--
function printChart(s5,s4,s3,s2,s1){
	...
	if(s1==0 && s2==0 && s3==0 && s4==0 && s5==0 ){
		...
		var ticks = [['<BR><span style="font-size:12px">많이 부족<BR>합니다&nbsp;&nbsp;<span>',s1,s1+'%'], ['<BR><span style="font-size:12px">부족&nbsp;&nbsp;<BR>합니다<span>',s2,s2+'%'], ['<BR><span style="font-size:12px">보통&nbsp;&nbsp;<BR>입니다<span>',s3,s3+'%'], ['<BR><span style="font-size:12px">만족&nbsp;&nbsp;<BR>합니다<span>',s4,s4+'%'] , ['<BR><span style="font-size:12px">아주&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<BR>만족합니다<span>',s5,s5+'%']];
		//바챠트1
		var mixTicks = ['항목'];
...
function printChart2(s1,s2,s3,s4,s5){
	...
	if(s1==0 && s2==0 && s3==0 && s4==0 && s5==0 ){
		...
		var ticks = [['<BR><span style="font-size:12px">권하고 싶지<BR>않습니다&nbsp;&nbsp;&nbsp;<span>',s1,s1+'%'], ['<BR><span style="font-size:12px">다소 권하고&nbsp;&nbsp;<BR>싶지 않습니다<span>',s2,s2+'%'], ['<BR><span style="font-size:12px">보통&nbsp;&nbsp;<BR>입니다<span>',s3,s3+'%'], ['<BR><span style="font-size:12px">권하고&nbsp;&nbsp;<BR>싶습니다<span>',s4,s4+'%'] , ['<BR><span style="font-size:12px">적극 권하고<BR>싶습니다&nbsp;&nbsp;&nbsp;<span>',s5,s5+'%']];
		//바챠트1
		var mixTicks = ['항목'];
...
?>
	...
	<table style="width:800px; border-collapse:collapse; border-spacing:0px; border:1px solid #000; margin-bottom:50px; ">
        <tr>
