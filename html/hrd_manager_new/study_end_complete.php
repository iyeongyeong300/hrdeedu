...
if($TOT_NO>0) {
	...
	if($mode=="ResultViewCancel") {
		$Sql = "UPDATE StudyEnd SET ResultViewInputID='', ResultViewInputDate='' WHERE CompanyCode='$CompanyCode' AND LectureStart='$LectureStart' AND LectureEnd='$LectureEnd'";
		$Row = mysqli_query($connect, $Sql);
	}
	if($mode=="StudyEndCancel") {
		$Sql = "UPDATE StudyEnd SET StudyEndInputID='', StudyEndInputDate='' WHERE CompanyCode='$CompanyCode' AND LectureStart='$LectureStart' AND LectureEnd='$LectureEnd'";
		$Row = mysqli_query($connect, $Sql);
	}
...
if($mode=="ResultViewCancel") {
	...
	$Sql2 = "UPDATE Study SET ResultView='N' WHERE CompanyCode='$CompanyCode' AND LectureStart='$LectureStart' AND LectureEnd='$LectureEnd' AND (ServiceType=1 OR ServiceType=3 OR ServiceType=5 OR ServiceType=9)";
	$Row2 = mysqli_query($connect, $Sql2);
...
if($mode=="StudyEndCancel") {
	...
	$Sql2 = "UPDATE Study SET StudyEnd='N' WHERE CompanyCode='$CompanyCode' AND LectureStart='$LectureStart' AND LectureEnd='$LectureEnd' AND (ServiceType=1 OR ServiceType=3 OR ServiceType=5 OR ServiceType=9)";
	$Row2 = mysqli_query($connect, $Sql2);
