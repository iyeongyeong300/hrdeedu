            ...
            <div class="conZone">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                  ...
                  <tr>
					...
					<?
					$SQL = "SELECT a.*, b.Name, c.CompanyName, c.CompanyCode FROM EmailSendLog AS a LEFT OUTER JOIN Member AS b ON a.ID=b.ID LEFT OUTER JOIN Company AS c ON b.CompanyCode=c.CompanyCode $where $str_orderby LIMIT $PAGE_CLASS->page_start, $page_size";
                  ...
                  <tr>
					...
					<td><?=$Email?></td>
					<td class="tl"><?=strip_tags($Massage)?></td>
					<td><?=$RegDate?></td>
