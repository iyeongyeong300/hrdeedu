...
(function($, w) {
    ...
    var Menu = function(options) {
        ...
        this.defaults = {
            ...
            secondFontSize: '16px',
            secondFontColor: this.themeColor.bluesub.fontColor,
            secondBgColor: this.themeColor.bluesub.bgColor,
            secondHoverFontColor: this.themeColor.bluesub.hoverFontColor,
            secondHoverBgColor: this.themeColor.bluesub.hoverBgColor,
        ...
        responsiveLayout: function() {
            ...
            if (screenWidth <= 1000) {
                if (!$menuIcon.length) {
                    ...
                    $menuIcon = $('.ve-menu-icon');
                    $menuIcon.css('marginTop', 17)
                    $menuIcon.css('marginBottom', 17)
                        .on('click', function() {
                            // 创建遮罩和一、二级菜单
