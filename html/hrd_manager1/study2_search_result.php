...
<table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
	<tr>
		<th><input type="checkbox" name="AllCheck" id="AllCheck" value="Y" onclick="CheckBox_AllSelect('check_seq')" style="width:17px; height:17px; background:none; border:none;" /></th>
		<th>번호<br />구분</th>
		<th>이름<br />ID</th>
		<th>과정명<br />수강기간</th>
		<th>진도율</th>
	...
	?>
	<tr>
		<td align="center" bgcolor="#FFFFFF" class="text01"><font color="#FFFFFF"><?=$Seq?></font><br><input type="checkbox" name="check_seq" id="check_seq" value="<?=$Seq?>" style="width:17px; height:17px; background:none; border:none;" /></td>
		...
		<?if($AdminWrite=="Y") {?>
			<?if($StudyEnd=="N") {?>
			<?if($MidStatus=="C" || $MidStatus=="Y") {?><input type="button" name="MidResetBtn" id="MidResetBtn" value="중간" class="btn_inputSm01" onclick="MidResetProcess('<?=$Name?>','<?=$Seq?>')" /><?}?>
			<?if($TestStatus=="C" || $TestStatus=="Y") {?><br /><input type="button" name="TestResetBtn" id="TestResetBtn" value="최종" class="btn_inputSm01" onclick="TestResetProcess('<?=$Name?>','<?=$Seq?>')" /><?}?>
			<?if($ReportStatus=="C" || $ReportStatus=="Y") {?><br /><input type="button" name="ReportResetBtn" id="ReportResetBtn" value="과제" class="btn_inputSm01" onclick="ReportResetProcess('<?=$Name?>','<?=$Seq?>')" /><?}?>
			<?}?>
		<?}?>
		</td>
