...
//-->
		...
		*/
		...
		?>
		<tr bgcolor="<?=$bgcolor?>" >
			<td align="center" class="text01" rowspan="2"><input type="checkbox" name="check_seq" id="check_seq" value="<?=$idx?>" style="width:17px; height:17px; background:none; border:none;"><br><img src="images/btn_edit04.gif" style="padding-top:5px; cursor:pointer" onclick="LectureRegEdit('<?=$idx?>');"><?//=$idx?></td>
			<td rowspan="2"><?=$i?></td>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<?}else{?>
				<input type="button" id="BtnSubmit" value="수강 등록하기" onclick="LectureRegistSubmitOk()" class="btn_inputBlue01">
				<?}?>
				</td>
