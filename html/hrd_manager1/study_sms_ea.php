        ...
        <div class="contentBody">
            ...
            <div class="conZone">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
				  ...
				  <tr>
                    <th>메세지</th>
                    <td><textarea name="Massage" id="Massage" style="width:400px;height:200px"><?=$Massage?></textarea></td>
                  </tr>
                </table>
				</form>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="gapT20">
					<tr>
						...
						<td align="center">
						<span id="SubmitBtn"><input type="button" value="발송 하기" onclick="SmsEaSubmitOk()" class="btn_inputBlue01"></span>
