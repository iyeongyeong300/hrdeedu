...
<? include "./include/include_top.php"; ?>
        ...
        <div class="contentBody">
        	<!-- ########## -->
            <h2>알림톡 전환전송 내역(LMS) | <span class="fs12 fcfff">알림톡 전환전송 내역(LMS) 입니다.</span></h2>
<?
            ...
            <div class="conZone">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                  ...
                  <tr>
					...
					<?
					$SQL = "SELECT * FROM MTS_MMS_MSG $where $str_orderby LIMIT $PAGE_CLASS->page_start, $page_size";
