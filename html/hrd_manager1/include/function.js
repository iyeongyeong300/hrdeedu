...
function MemberInfo(ID) {
	...
	$("#DataResult").load("./member_info_pop.php",
	{ 'ID': ID
	},function(){
...
function CourseInfo(LectureCode) {
	...
	$("#DataResult").load("./course_info_pop.php",
...
function CompanyInfo(CompanyCode) {
	...
	$("#DataResult").load("./company_info_pop.php",
...
function ProgressInfo(ID,LectureCode,Study_Seq) {
	...
	$("#DataResult").load("./progress_info_pop.php",
	{ 'ID': ID,
		'LectureCode': LectureCode,
		'Study_Seq': Study_Seq
	},function(){
...
function ProgressInfoLog(i,ID,LectureCode,Study_Seq,Chapter_Seq,Contents_idx) {
	...
	if($("tr[id='ProgressDetail']:eq("+i+")").css("display") == "none" ) {
		...
		$("div[id='Progress_log']:eq("+i+")").load('./progress_info_pop_log.php',
		{ 'ID': ID,
			'LectureCode': LectureCode,
			'Study_Seq': Study_Seq,
...
function DeptSubCategoryView(Dept,DivName,idx,Deep) {
	...
	$('#'+DivName).load("./dept_category_sub.php",
	{ 'idx': idx,
		'Deep': Deep,
		'Dept': Dept
	});
...
function DeptSubCategoryViewSelect(Dept,DivName,idx,Deep) {
	...
	$('#'+DivName).load("./dept_category_sub_select.php",
	{ 'idx': idx,
		'Deep': Deep,
		'Dept': Dept
	});
...
function IDCheck() {
	...
	$("span[id='id_check_msg']").load('./id_check.php',
		{	'ID': ID
		},function(){
...
function PasswordInit() {
	...
	Yes = confirm("비밀번호를 1111 으로 초기화 하시겠습니까?");
	if(Yes==true) {
		PasswordForm.submit();
	}
...
function CompanyCodeCheck() {
	...
	$("span[id='CompanyCode_check_msg']").load('./companycode_check.php',
		{	'CompanyCode': CompanyCode
		},function(){
...
function CompanyIDCheck() {
	...
	$("span[id='CompanyID_check_msg']").load('./companyid_check.php',
		{	'CompanyID': CompanyID
		},function(){
...
function SalesManagerSearch() {
	...
	*/
	$("span[id='SalesManagerHtml']").load('./salesmanager_search.php',
		{	'SalesName': SalesName
		},function(){
...
function MemberIDCheck() {
	...
	$("span[id='id_check_msg']").load('./member_id_check.php',
		{	'ID': ID
		},function(){
...
function MemberCompanySearch() {
	...
	$("span[id='company_search_result']").load('./member_company_search.php',
...
function ContentsDetail(mode,Seq,Contents_idx) {
	...
	$("#DataResult").load("./contents_detail.php",
	{ 'mode': mode,
		'Seq': Seq,
		'Contents_idx': Contents_idx
	},function(){
...
function CourseCategorySelect() {
	...
	$("span[id='Category2Area']").load('./course_category_select.php',
		{	'Category1': Category1Selected
		},function(){
...
function UploadFile(Ele,EleArea,FileType) {
	...
	$("#DataResult").load("./upload_file.php",
	{ 'Ele': Ele,
		'EleArea': EleArea,
		'FileType': FileType
	},function(){
...
function CourseCopy() {
	...
	$("#DataResult").load("./course_copy.php",
	{ 't': '1111'
	},function(){
...
function ChapterRegist(mode,LectureCode,Chapter_seq, ContentGubunOnly) {
	...
	$("#DataResult").load("./chapter_regist.php",
	{ 'mode': mode,
		'LectureCode': LectureCode,
		'Chapter_seq': Chapter_seq,
		'ContentGubunOnly': ContentGubunOnly
	},function(){
...
function ChapterContentsSelect(Sub_idx) {
	...
	*/
	...
	$("div[id='Content_idx_div']").load('./chapter_content_select.php',
...
function ChapterExamSelect() {
	...
	*/
	...
	$("div[id='Exam_idx_div']").load('./chapter_exam_select.php',
		{	'ExamGubun': ExamGubun,
			'ChapterType':checked_value
		},function(){
...
function ChapterListRoading() {
	...
	$("div[id='ChapterList']").load('./course_read_list.php',
		{	'LectureCode': LectureCodeValue
		},function(){
...
function ChapterCopy(TargetLectureCode) {
	...
	$("#DataResult").load("./chapter_copy.php",
	{ 'TargetLectureCode': TargetLectureCode
	},function(){
...
function PackageSearch() {
	...
	$("span[id='PackageSearchResult']").load('./package_search.php',
...
function PackageSearchSelect() {
	...
	var row = '<tr>';
		...
		row += '<input type="button" value="▲" onclick="PackageChapterListMoveUp(this);" style="width:30px;"> <input type="button" value="▼" onclick="PackageChapterListMoveDown(this);" style="width:30px;"></td>';
...
function LectureRegIDSearch() {
	...
	*/
	$("span[id='SearchIDResult']").load('./lecture_reg_id_search.php',
...
function LectureRegTutorSearch() {
	...
	*/
	$("span[id='SearchTutorResult']").load('./lecture_reg_tutor_search.php',
		{	'TempSearchTutor': TempSearchTutor
		},function(){
...
function ExcelUploadListRoading(str) {
	...
	$("div[id='ExcelUploadList']").load('./lecture_reg_list.php',
		{	'str': str
		},function(){
...
function LectureRegEdit(idx) {
	...
	$("#DataResult").load("./lecture_reg_edit.php",
	{ 'idx': idx
	},function(){
...
function LectureRegistProcess(i) {
	...
	if(i<LectureRegist_Seq_count) {
		...
		$("span[id='LectureRegResult']:eq("+i+")").load("./lecture_reg_complete.php",
		{ 'Seq': $("input[id='check_seq']:eq("+i+")").val()
		},function(){
			setTimeout(function(){
...
function LectureRequestStatus(ID,idx,i) {
	...
	if(Yes==true) {
		...
		$.post("./lecture_request_change.php",
			{ 'ID': ID,
				'idx': idx,
				'Status': Status,
				'Payment': Payment,
...
function LectureTermeSearch() {
	...
	$("span[id='LectureTermeResult']").load('./study_lectureterme.php',
...
function LectureCompanySearch() {
	...
	if(StudyPeriod=="") {
		...
		$("span[id='LectureCompanyResult']").load('./study_lectureterme_company.php',
...
function StudyCheckedDelete() {
	...
	if(Yes==true) {
		...
		$.post("./study_search_checked_delete.php",
		{
			'seq_value': seq_value
		},function(data,status){
...
function StudyIPSearch(pg) {
	...
	*/
	...
	$.post("./study_ip_search_result.php",
	{
		'SearchGubun': SearchGubun,
		'CompanyName': CompanyName,
		'SearchYear': SearchYear,
...
function StudyCorrectSearch(pg) {
	...
	*/
	...
	$.post("./study_correct_search_result.php",
	{
		'SearchGubun': SearchGubun,
		'CompanyName': CompanyName,
		'SearchYear': SearchYear,
...
function StudyCorrectSearch2(pg) {
	...
	*/
	...
	$.post("./study_correct2_search_result.php",
	{
		'SearchGubun': SearchGubun,
		'CompanyName': CompanyName,
		'SearchYear': SearchYear,
...
function StudyEndSearch(pg) {
	...
	$.post("./study_end_search_result.php",
	{
		'SearchGubun': SearchGubun,
		'CompanyName': CompanyName,
		'SearchYear': SearchYear,
...
function StudyEndComplete(CompanyCode, LectureStart, LectureEnd, mode) {
	...
	Yes = confirm("["+msg+"] 하시겠습니까?");

	if(Yes==true) {

		$.post("./study_end_complete.php",
		{
			'CompanyCode': CompanyCode,
			'mode': mode,
			'LectureStart': LectureStart,
...
function StudySmsSearch() {
	...
	$.post("./study_sms_search_result.php",
	{
		'SearchGubun': SearchGubun,
		'CompanyName': CompanyName,
		'SearchYear': SearchYear,
...
function StudySmsSend(send_mode) {
	...
	Yes = confirm('현재 검색 결과로 '+Msg+'\n\n발송 작업은 처음부터 '+totalcount+'번 항목까지 순차적으로 진행됩니다.\n\n작업이 완료 될 때 까지 기다려 주세요.\n\n\n\n작업을 진행하시려면 [확인]을 클릭하세요.');
	if(Yes==true) {
		batching = true;
...
function StudySmsEASend(Seq,MessageMode) {
	...
	$("#DataResult").load("./study_sms_ea.php",
...
function StudyIPChapter(Seq) {
	...
	$("#DataResult").load("./study_ip_chapter.php",
	{ 'Seq': Seq
	},function(){
...
function StudyPaymentSearch(pg) {
	...
	$.post("./study_payment_search_result.php",
	{
		'SearchGubun': SearchGubun,
		'CompanyName': CompanyName,
		'SearchYear': SearchYear,
...
function PaymentSave(k,LectureStart,LectureEnd,CompanyCode){
	...
	if(Yes==true) {
		...
		$.post("./study_payment_progress.php",
		{
			'CompanyCode': CompanyCode,
			'LectureStart': LectureStart,
			'LectureEnd': LectureEnd,
...
function ExamExcelUploadListRoading(str) {
	...
	$("div[id='ExcelUploadList']").load('./exam_bank_excel_list.php',
		{	'str': str
		},function(){
...
function ExamBankRegistSubmitOk() {
	...
	if(ExamBank_Regist_Seq_count<1) {
		...
		Yes = confirm("등록한 엑셀파일로 문제은행 등록을 시작하시겠습니까?\n\n\n\n목록 우측 [상태]항목에서 문제은행 등록 진행상황을\n\n확인하실 수 있습니다.\n\n\n\n작업이 완료될 때까지 다른 페이지로 이동 또는 창을 닫지 마세요.");
		if(Yes==true) {
			TimeCheckNo = "N"; //로그아웃까지 남은 시간 실행 중지
...
function ExamBankRegistProcess(i) {
	...
	if(i<ExamBank_Regist_Seq_count) {
		...
		$("span[id='ExamBankRegResult']:eq("+i+")").load("./exam_bank_reg_complete.php",
		{ 'Seq': $("input[id='check_seq']:eq("+i+")").val()
		},function(){
			setTimeout(function(){
...
function ExamBankRegEdit(idx) {
	...
	$("#DataResult").load("./exam_bank_reg_edit.php",
	{ 'idx': idx
	},function(){
...
function ExamBankCheckedDelete() {
	...
	if(Yes==true) {
		...
		$.post("./exam_bank_checked_delete.php",
		{
			'seq_value': seq_value
		},function(data,status){
...
function CompanyRegEdit(idx) {
	...
	$("#DataResult").load("./company_reg_edit.php",
	{ 'idx': idx
	},function(){
...
function TestIDView(LectureCode) {
	...
	$("#DataResult").load("./course_testid_view.php",
	{ 'LectureCode': LectureCode
	},function(){
...
function StudyCheckedKakaoTalk(mode) {
	...
	if(Yes==true) {
		...
		$.post("./study_search_checked_kakaotalk.php",
		{
			'seq_value': seq_value,
			'mode': mode
		},function(data,status){
...
function StudyCheckedEduManagerMail() {
	...
	if(Yes==true) {
		...
		$.post("./study_search_checked_edumanager_mail.php",
		{
			'seq_value': seq_value
		},function(data,status){
...
function CertificatePrint(Seq) {
	...
	$("#DataResult").load("./certificate_layer.php",
	{ 'Seq': Seq
	},function(){
...
function StudyEndCertificatePrintPDF(CompanyCode,LectureStart,LectureEnd,ServiceTypeYN) {
	var url='/mypage/certificate_pdf02.php?CompanyCode='+CompanyCode+'&LectureStart='+LectureStart+'&LectureEnd='+LectureEnd+'&ServiceTypeYN='+ServiceTypeYN;
	window.open(url,'certi','scrollbars=yes, resizable=yes, left=400, width=820, height=700');
}

function StudyEndDocument(CompanyCode,LectureStart,LectureEnd,ServiceTypeYN) {
	var url='./study_end_doc.php?CompanyCode='+CompanyCode+'&LectureStart='+LectureStart+'&LectureEnd='+LectureEnd+'&ServiceTypeYN='+ServiceTypeYN;
	window.open(url,'doc','scrollbars=yes, resizable=yes, left=400, width=820, height=700');
}

function StudyEndDocumentPoll(CompanyCode,LectureStart,LectureEnd) {
	var url='./study_end_doc_poll.php?CompanyCode='+CompanyCode+'&LectureStart='+LectureStart+'&LectureEnd='+LectureEnd;
	window.open(url,'doc','scrollbars=yes, resizable=yes, left=400, width=820, height=700');
}
...
function CompanySearchAutoCompleteGo() {
	...
	if(str_len > 0) {
		...
		$("#CompanyAutoCompleteResult").load('./study_company_search_autocomplete.php',
		{ 'CompanyName': str
		},function(){
...
function CompanySearchLectureTermeSearch(CompanyCode) {
	...
	$("span[id='CompanySearchLectureTermeResult']").load('./study_company_lectureterme.php',
		{	'CompanyCode': CompanyCode,
			'ctype': $("#ctype").val(),
			'SubmitFunction': SubmitFunction
		},function(){
...
function TaxBillPublisherEdit() {
	...
	$("#DataResult").load("./taxbill_publisher_info.php",
	{ 't': 'bill'
	},function(){
...
function TaxBillCompanySearch() {
	...
	$("#DataResult").load("./taxbill_company_search.php",
	{ 't': 'bill'
	},function(){
...
function TaxBillCompanySearchSubmit() {
	...
	$("#TaxBillCompanySearchResult").load("./taxbill_company_search_result.php",
	{ 'CompanyName': $("#StrCompanyName").val()
	},function(){
...
function TaxBillEduPublish(CompanyCode,Price,CourseUniq,LectureStart,LectureEnd) {
	...
	$("#DataResult").load("./taxbill_edu_publish.php",
	{ 'CompanyCode': CompanyCode,
		'Price': Price,
		'CourseUniq': CourseUniq,
		'LectureStart': LectureStart,
		'LectureEnd': LectureEnd
	},function(){
...
function SaleStaSearch() {
	...
	*/
	...
	$.post("./sale_sta_search_result.php",
	{
		'Dept_idx': Dept_idx,
...
function SaleStaDeptDetail(ID) {
	...
	$("#DataResult").load("./sale_sta_result_detail.php",
	{ 
		'Dept_idx': Dept_idx,
		'DeptString': DeptString,
		'StartColume': StartColume,
...
function ContentsExcelUploadListRoading(str) {
	...
	$("div[id='ContentsUploadList']").load('./contents_excel_list.php',
		{	'str': str
		},function(){
...
function ContentsRegistSubmitOk() {
	...
	if(Contents_Regist_Seq_count<1) {
		...
		Yes = confirm("등록한 엑셀파일로 기초차시 등록을 시작하시겠습니까?\n\n\n\n목록 우측 [상태]항목에서 기초차시 등록 진행상황을\n\n확인하실 수 있습니다.\n\n\n\n작업이 완료될 때까지 다른 페이지로 이동 또는 창을 닫지 마세요.");
		if(Yes==true) {
			TimeCheckNo = "N"; //로그아웃까지 남은 시간 실행 중지
...
function ContentsRegistProcess(i) {
	...
	if(i<Contents_Regist_Seq_count) {
		...
		$("span[id='ContentsRegResult']:eq("+i+")").load("./contents_reg_complete.php",
		{ 'Seq': $("input[id='check_seq']:eq("+i+")").val()
		},function(){
			setTimeout(function(){
...
function ContentsRegEdit(idx) {
	...
	$("#DataResult").load("./contents_reg_edit.php",
	{ 'idx': idx
	},function(){
...
function StudyPaymentSearch2(pg) {
	...
	$.post("./study2_payment_search_result.php",
	{
		'SearchGubun': SearchGubun,
		'CompanyName': CompanyName,
		'SearchYear': SearchYear,
...
function PaymentSave2(k,ID,Seq){
	...
	if(Yes==true) {
		...
		$.post("./study2_payment_progress.php",
		{
			'ID': ID,
			'Seq': Seq,
			'mode': mode,
...
function InformationProtection(TB,Field,ele,ID,url,Exp) {
	...
	$("#DataResult2").load("./Information_protection_regist.php",
	{ 'TB': TB,
		'Field': Field,
		'ele': ele,
		'ID': ID,
...
function InformationProtectionView(TB,Field,ele,ID) {
	...
	$.post("./Information_protection.php",
	{
		'TB':TB,
		'Field': Field,
		'ele': ele,
...
function SimpleAskDetail(idx) {
	...
	$("#DataResult").load("./simple_ask_detail.php",
	{ 'idx': idx
	},function(){
...
function InformationProtectionUrl(TB,url,Exp,send_url,ID) {
	...
	$("#DataResult2").load("./Information_protection_regist2.php",
	{ 'TB': TB,
		'url': url,
		'Exp': Exp,
		'send_url': send_url,
...
function CaptionUploadFile(Ele,EleArea) {
	...
	$("#DataResult2").load("./caption_upload_file.php",
	{ 'Ele': Ele,
		'EleArea': EleArea
	},function(){
