...
?>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
                  ...
                  <tr>
                    <th>카테고리</th>
                    <td><span id="DeptCategorySelected"></span>&nbsp;<input type="button" value="카테고리 찾기" onclick="DeptCategorySelect('C');" class="btn_inputLine01"></td>
                  </tr>
				  <?if($mode=="new") {?>
				  <tr>
                    <th>아이디</th>
                    <td><input name="ID" id="ID" type="text"  size="40" value="" maxlength="30">&nbsp;&nbsp;<input type="button" value="중복 검색" onclick="IDCheck();" class="btn_inputLine01">&nbsp;&nbsp;&nbsp;&nbsp;<span id="id_check_msg"></span></td>
                  </tr>
				  <?}else{?>
				  <tr>
                    <th>아이디</th>
