...
?>
	...
	<div class="btnAreaTl02">
		<span class="fs16b fc333B"><img src="images/sub_title2.gif" align="absmiddle">학습 내역</span>
	</div>
	...
	<table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
		...
		<tr bgcolor="#FFFFFF">
			<td ><?=$k?></td>
			<td align="left"><a href="Javascript:ProgressInfoLog(<?=$k-1?>,'<?=$ID?>','<?=$LectureCode?>','<?=$Study_Seq?>','<?=$ROW['Chapter_Seq']?>','<?=$ROW['Contents_idx']?>');"><?=$ROW['ContentsTitle']?></a></td>
