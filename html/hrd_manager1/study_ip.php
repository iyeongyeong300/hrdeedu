			...
			<div class="neoSearch">
                ...
                <!-- btn -->
			  	<div class="mt10 tc pb5">
                	<input type="button" name="SearchBtn" id="SearchBtn" value="검 색" class="btn_inputBlue01" style="width:230px;" onclick="StudyIPSearch(1)">&nbsp;&nbsp;
                    <input type="button" name="ExcelBtn" id="ExcelBtn" value="검색 결과 엑셀 출력" class="btn_inputLine01" style="width:230px;" onclick="StudyIPExcel();">
	      		</div>
                <!-- btn // -->
			</div>
			</form>
