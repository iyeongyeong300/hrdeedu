...
?>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="gapT20">
		<tr>
			<td>&nbsp;</td>
			<td height="35" align="center"><input type="button" class="btn_inputLine01" value="수료증 출력하기" onclick="CertificatePrintPage(<?=$Seq?>)">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="btn_inputLine01" value="수료증 PDF로 출력하기" onclick="CertificatePrintPDF(<?=$Seq?>)"></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td align="left" width="100">&nbsp;</td>
			<td align="center"> </td>
			<td width="100" align="right"><input type="button" value="닫  기" onclick="DataResultClose();" class="btn_inputLine01"></td>
		</tr>
	</table>
