...
?>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
                  ...
                  <tr>
                    <th>비밀번호</th>
                    <td><input name="Passwd" type="password" class="wid200" value="********" disabled>&nbsp;<input type="checkbox" name="PwdChange" id="PwdChange" value="Y" onclick="PassChange()" style="width:18px">&nbsp;<label for="PwdChange">* 비밀번호 변경시 체크하세요.</label></td>
                  </tr>
				  <tr>
                    <th>비밀번호 재입력</th>
