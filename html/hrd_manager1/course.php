            ...
            <div class="conZone">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                  ...
                  <tr>
					...
					<td align="left"><A HREF="Javascript:readRun('<?=$idx?>');"><span class="sm"><?=$Category1Name?> <?if($Category2Name) {?> > <?=$Category2Name?><?}?></span><br><?if($Hit=="Y") {?><span class="redB">[인기]</span> <?}?><strong><?=$ContentsName?></strong></A></td>
