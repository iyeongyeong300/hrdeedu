...
?>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
                  ...
                  <tr>
                    ...
                    <td><input name="Photo" id="Photo" type="hidden" value="<?=$Photo?>"><span id="PhotoArea"><?=$PhotoView?></span>&nbsp;<input type="button" value="파일 첨부" onclick="UploadFile('Photo','PhotoArea','img');" class="btn_inputLine01"></td>
                  </tr>
                  <tr>
                    <th>약력</th>
