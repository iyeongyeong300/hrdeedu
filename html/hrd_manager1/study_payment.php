...
<? include "./include/include_top.php"; ?>
        ...
        <div class="contentBody">
        	<!-- ########## -->
            <h2>결제관리 | <span class="fs12 fcfff">사업자의 교육비 결제를 관리합니다.</span></h2>
			...
			<div class="neoSearch">
				...
				<div class="mt10 tc pb5">
                	<input type="button" name="SearchBtn" id="SearchBtn" value="검 색" class="btn_inputBlue01" style="width:230px;" onclick="StudyPaymentSearch()">&nbsp;&nbsp;
