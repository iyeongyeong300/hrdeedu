...
?>
            <div class="conZone">
				...
				<div class="btnAreaTr02">
					<input type="button" value="체크 항목 삭제" onclick="ExamBankCheckedDelete()" class="btn_inputLine01">&nbsp;&nbsp;
					<input type="button" value="엑셀로 문제 등록" onclick="location.href='<?=$PageName?>_excel.php'" class="btn_inputLine01">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                  ...
                  <tr>
					...
					?>
                  <tr>
					<td><font color="#FFFFFF"><?=$idx?></font><br><input type="checkbox" name="check_seq" id="check_seq" value="<?=$idx?>" style="width:17px; height:17px; background:none; border:none;" /></td>
					<td><?=$PAGE_UNCOUNT--?></td>
