...
<? include "./include/include_top.php"; ?>
        ...
        <div class="contentBody">
        	<!-- ########## -->
            <h2>수강마감 | <span class="fs12 fcfff">마감을 통해 수강생에게 결과를 통보하거나 최종결과를 확정짓습니다.</span></h2>
			...
			<div class="neoSearch">
				...
				<div class="mt10 tc pb5">
                	<input type="button" name="SearchBtn" id="SearchBtn" value="검 색" class="btn_inputBlue01" style="width:230px;" onclick="StudyEndSearch()">&nbsp;&nbsp;
