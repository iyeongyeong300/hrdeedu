            ...
            <div class="conZone">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                  ...
                  <tr>
					...
					<?
					$SQL = "SELECT a.*, b.CompanyName, AES_DECRYPT(UNHEX(a.Email),'$DB_Enc_Key') AS Email, AES_DECRYPT(UNHEX(a.Mobile),'$DB_Enc_Key') AS Mobile, AES_DECRYPT(UNHEX(a.BirthDay),'$DB_Enc_Key') AS BirthDay, AES_DECRYPT(UNHEX(a.ResNo),'$DB_Enc_Key') AS ResNo  FROM Member AS a LEFT OUTER JOIN Company AS b ON a.CompanyCode=b.CompanyCode LEFT OUTER JOIN StaffInfo AS c ON b.SalesManager=c.ID $where $str_orderby LIMIT $PAGE_CLASS->page_start, $page_size";
					//echo $SQL;
