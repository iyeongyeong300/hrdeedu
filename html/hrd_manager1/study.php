        ...
        <div class="contentBody">
			...
			<div class="neoSearch">
				...
				<div class="mt10 tc pb5">
                	<input type="button" name="SearchBtn" id="SearchBtn" value="검 색" class="btn_inputBlue01" style="width:230px;" onclick="StudySearch(1)">&nbsp;&nbsp;
					
				</div>
				<?if($AdminWrite=="Y") {?>
				<div class="pb5" style="width:1250px; margin:10px auto 0 auto">
					<input type="button" name="ExcelBtn" id="ExcelBtn" value="검색 결과 엑셀 출력" class="btn_inputLine01" style="width:240px;" onclick="StudyExcel();">
					...
					<input type="button" name="ChangeBtn" id="ChangeBtn" value="현재 검색 조건으로 개설용도 변경" class="btn_inputLine01" style="width:240px;" onclick="StudyServiceTypeChangeBatch()">
				...
				<div class="pb5" style="width:1250px; margin:0 auto 0 auto">
