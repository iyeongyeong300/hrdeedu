        ...
        <div class="contentBody">
			...
			<div class="neoSearch">
				...
				<div class="mt10 tc pb5">
                	<input type="button" name="SearchBtn" id="SearchBtn" value="검 색" class="btn_inputBlue01" style="width:230px;" onclick="StudyCorrectSearch2(1)">&nbsp;&nbsp;
