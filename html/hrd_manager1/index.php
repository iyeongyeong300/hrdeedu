...
?>
    ...
    <div class="Login">
        ...
        <ul>
            ...
            <li><input type="text" name="ID" id="ID" onblur="FocusSend();" value="<?=$_COOKIE["AdminSavedID"]?>" autocomplete="off" /></li>
            <li><input type="password" name="Passwd" id="Passwd" autocomplete="off" /></li>
    ...
    <!-- Footer -->
    <div class="Footer"><?=$SiteAddress?></div>
    <!-- Footer // -->
