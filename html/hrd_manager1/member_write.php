...
//-->
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
                  ...
                  <tr>
                    <th>아이디</th>
                    <td><input name="ID" id="ID" type="text"  size="20" value="<?=$ID?>">&nbsp;&nbsp;<input type="button" value="중복 검색" onclick="MemberIDCheck();" class="btn_inputLine01">&nbsp;&nbsp;&nbsp;&nbsp;<span id="id_check_msg"></span></td>
                  </tr>
				  <?}else{?>
                  <tr>
                    <th>아이디</th>
				  ...
				  <tr>
                    <th>회사명</th>
                    <td><input name="CompanyName" id="CompanyName" type="text"  size="40" value="<?=$CompanyName?>"> <input type="button" value="검색" onclick="MemberCompanySearch();" class="btn_inputLine01">&nbsp;&nbsp;<span id="company_search_result"></span></td>
                  </tr>
				  <tr>
                    <th>부서</th>
