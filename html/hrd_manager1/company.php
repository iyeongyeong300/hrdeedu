...
?>
            <div class="conZone">
				...
				<?if($AdminWrite=="Y") {?>
					...
					<input type="button" name="ExcelBtn" id="ExcelBtn" value="엑셀로 등록" class="btn_inputBlue01" onClick="location.href='<?=$PageName?>_write_excel.php'">
				<?}?>
              	</div>
                <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                  ...
                  <tr>
					...
					<td><?=$StaffName?></td>
					<td><?=$CyberEnabled_array[$CyberEnabled]?></td>
					<td><?=$CompanyID?></td>
                ...
                <div class="btnAreaTr02">
				<?if($AdminWrite=="Y") {?>
					<input type="button" name="ExcelOutBtn" id="ExcelOutBtn" value="검색항목 엑셀 출력" class="btn_inputLine01" onClick="location.href='<?=$PageName?>_excel.php?Gubun=<?=$Gubun?>&col=<?=$col?>&sw=<?=$sw?>'">
				<?}?>
              	</div>
