...
//-->
				...
				<tr>
					...
					<table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
						<tr>
							<td bgcolor="#e2e9ed" class="text01" width="80" align="center">객관식</td>
							...
							<td bgcolor="#e2e9ed" class="text01" width="80" align="center">단답형</td>
							...
							<td bgcolor="#e2e9ed" class="text01" width="80" align="center">서술형</td>
				...
				<tr>
					...
					<table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
						<tr>
							<td bgcolor="#e2e9ed" class="text01" width="80" align="center">객관식</td>
							<td bgcolor="#FFFFFF">문항수 : <input name="Test01EA" id="Test01EA" type="text"  size="6" value="<?=$Test01EA?>" maxlength="2"> 문항&nbsp;&nbsp;/&nbsp;&nbsp;배점 : <input name="Test01Score" id="Test01Score" type="text"  size="6" value="<?=$Test01Score?>" maxlength="3"> 점&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td bgcolor="#e2e9ed" class="text01" width="80" align="center">단답형</td>
							<td bgcolor="#FFFFFF">문항수 : <input name="Test02EA" id="Test02EA" type="text"  size="6" value="<?=$Test02EA?>" maxlength="2"> 문항&nbsp;&nbsp;/&nbsp;&nbsp;배점 : <input name="Test02Score" id="Test02Score" type="text"  size="6" value="<?=$Test02Score?>" maxlength="3"> 점&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td bgcolor="#e2e9ed" class="text01" width="80" align="center">서술형</td>
							<td bgcolor="#FFFFFF">문항수 : <input name="Test03EA" id="Test03EA" type="text"  size="6" value="<?=$Test03EA?>" maxlength="2"> 문항&nbsp;&nbsp;/&nbsp;&nbsp;배점 : <input name="Test03Score" id="Test03Score" type="text"  size="6" value="<?=$Test03Score?>" maxlength="3"> 점&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						</tr>
					</table>
					</td>
				</tr>
