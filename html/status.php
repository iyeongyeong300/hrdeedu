...
$services[] = array("port" => "80",       "service" => "HTTP",                  "ip" => "222.239.103.71") ;
$services[] = array("port" => "443",       "service" => "HTTPS",                  "ip" => "222.239.103.71") ;
$services[] = array("port" => "3306",     "service" => "MYSQL",                   "ip" => "222.239.103.77") ;
