...
$Sql = "SELECT * FROM Member WHERE  ID='$ID' AND UseYN='Y' AND Mobile=$Mobile_enc ";
...
//④----------------------------------------------------------------------------------------------------------------
		...
		if($Row['PassChange']=="N") {
			//$url = "/mypage/myinfo_employer.php";
			$url = "/new/mypage/memberinfo.html";
			$TopLogin="N";
		} else {
			//$url = "/mypage/lecture.php";
			$url = "/new/mypage/lecture.html";
		}
